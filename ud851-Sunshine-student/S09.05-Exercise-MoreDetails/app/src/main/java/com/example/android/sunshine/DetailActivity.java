...
//      COOMPLETED (13) Find each of the TextViews by ID
        ...
        mWeatherHigh = (TextView) findViewById(R.id.tv_weather_high);
        mWeatherLow = (TextView) findViewById(R.id.tv_weather_low);
...
//      COMPLETED (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String dateString = SunshineDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);
