...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_INTERVAL_SECONDS = 10800;
    private static final int SYNC_FLEXTIME_SECONDS = 3600;

    private static boolean sInitialized;

//  COMPLETED (11) Add a sync tag to identify our sync job
    private static final String WEATHER_SYNC_JOB_TAG = "weather_sync_tag";
...
//  COMPLETED (12) Create a method to schedule our periodic weather sync
    private static void scheduleWeatherSync(Context context) {
        ...
        Job syncSunshineJob = dispatcher.newJobBuilder()
                ...
                /*
                 * We want weather sync to continuously happen, so we tell this Job to recur.
                 */
                .setRecurring(true)
                /*
                 * We want the reminders to happen every 3-4 hours. The first argument for
