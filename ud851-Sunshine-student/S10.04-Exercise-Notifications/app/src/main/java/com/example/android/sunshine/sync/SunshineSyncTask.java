...
//              COMPLETED (13) Check if notifications are enabled
                boolean notificationsAreEnabled = SunshinePreferences.areNotificationsEnabled(context);
...
//              COMPLETED (15) If more than a day have passed and notifications are enabled, notify the user
                if (timeSinceLastNotification >= DateUtils.DAY_IN_MILLIS && notificationsAreEnabled) {
