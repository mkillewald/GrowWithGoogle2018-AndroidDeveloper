...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeahterDetail.humidityValue.setText(humidityString);
        mDetailBinding.extraWeahterDetail.humidityValue.setContentDescription(humidityA11y);

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeahterDetail.humidityLabel.setContentDescription(humidityA11y);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeahterDetail.windValue.setText(windString);
        mDetailBinding.extraWeahterDetail.windValue.setContentDescription(windA11y);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeahterDetail.windLabel.setContentDescription(windA11y);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeahterDetail.pressureValue.setText(pressureString);
        mDetailBinding.extraWeahterDetail.pressureValue.setContentDescription(pressureA11y);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeahterDetail.pressureLabel.setContentDescription(pressureA11y);
