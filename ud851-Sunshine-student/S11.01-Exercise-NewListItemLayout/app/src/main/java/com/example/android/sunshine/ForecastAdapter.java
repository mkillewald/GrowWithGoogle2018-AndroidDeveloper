...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        /* get correct weather icon for condition */
        int weatherImageId;
        ...
        forecastAdapterViewHolder.weatherHighTemp.setText(highTemperature);
        forecastAdapterViewHolder.weatherLowTemp.setText(lowTemperature);
...
//          COMPLETED (6) Get references to all new views and delete this line
            ...
            weatherHighTemp = (TextView) view.findViewById(R.id.weather_high_temp);
            weatherLowTemp = (TextView) view.findViewById(R.id.weather_low_temp);
